...
The easiest way to install is by cloning the git repo. Then from the rootdirectory, use either of the methods listed below. We'll have pip and conda packages shortly.
